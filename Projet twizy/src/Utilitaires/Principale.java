...
public class Principale {
	...
	public static void main(String[] args)
	{
		...
		Mat Z=Highgui.imread("Temoin.png",Highgui.CV_LOAD_IMAGE_COLOR);
		...
		Mat Zblurred = MaBibliothequeTraitementImage.blurring(Z);
		MaBibliothequeTraitementImage.afficheImage("Image Floutée", Zblurred);
